...
st.set_page_config(page_title="Get info about the example website", page_icon=":robot_face:", layout="wide")
...
# Title
st.title("Get info about the example website")
...
for index, chat in enumerate(reversed(st.session_state['history'])):
    ...
    if isinstance(chat["answer"], pd.DataFrame):
        ...
        with col2_a:
            ...
            st.text_area("A:", value=chat["answer"], height=400, key=f"answer_{index}")
...
knowledge_base_prompts = [
    ...
    {"Prompt": "What is the content the example website?"}
]
