...
from opensearchpy import OpenSearch, RequestsHttpConnection, Urllib3AWSV4SignerAuth, Urllib3HttpConnection
...
if __name__ == '__main__':
    ...
    crawler = Crawler(starturl=os.getenv('CRAWLER_URL'), max_sites=100)
    crawler.run()
